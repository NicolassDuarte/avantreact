  ...
  const fetchTrocas = async () => {
    try {
      ...
      if (activeTab === "recebidas") {
        ...
        const finalizadas = todasTrocas.filter(
          (troca) => troca.status !== "PENDENTE"
        );
      ...
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-start">
          <img
            src={getImageUrl(
              isRecebida
                ? troca.itemOferecido.imagemUrl
                : troca.itemDesejado.imagemUrl
            )}
            alt={
              isRecebida
                ? troca.itemOferecido.titulo
                : troca.itemDesejado.titulo
            }
          ...
          <div>
            <h5 className="card-title">
              {isRecebida ? "Item Oferecido" : "Item Desejado"}:{" "}
              {troca.itemDesejado.titulo}
            </h5>
            <p className="card-text">
              <strong>{isRecebida ? "Ofertante" : "Receptor"}:</strong>{" "}
              {isRecebida ? troca.ofertante.nome : troca.receptor.nome}
            </p>
            <p className="card-text">
        ...
        {isRecebida && troca.status === "PENDENTE" && (
          <div className="mt-3">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                handleResponderProposta(troca.id_troca, "RECUSADA")
              }
            >
              Recusar
            </Button>
            ...
            <Nav variant="tabs" className="nav-custom">
              <Nav.Item>
                <Nav.Link eventKey="recebidas">
                  <FaBoxOpen /> Propostas Recebidas
                  {trocasRecebidas.length > 0 && (
                    <Badge bg="warning" className="ms-2">
                      {
                        trocasRecebidas.filter((t) => t.status === "PENDENTE")
                          .length
                      }
                    </Badge>
                  )}
              ...
              <Nav.Item>
                <Nav.Link eventKey="enviadas">
                  <FaBox /> Propostas Enviadas
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="finalizadas">
                  <FaBriefcase /> Trocas Finalizadas
                </Nav.Link>
              </Nav.Item>
            </Nav>
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p>
                        <strong>Dono:</strong> {selectedTroca.ofertante.nome}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p>
                        <strong>Dono:</strong> {selectedTroca.receptor.nome}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <p>
                    ...
                    {getStatusBadge(selectedTroca.status)}
                  </p>
                </div>
                <div className="col-md-6">
                  <p>
                    <strong>Data da proposta:</strong>{" "}
                    {new Date(selectedTroca.criadoEm).toLocaleDateString(
                      "pt-BR"
                    )}
                  </p>
                </div>
